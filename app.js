var MyApp = (() => {
  ...
  function Header({ currentPage, onPageChange, onOpenModal }) {
    ...
    const searchOptions = [
      ...
      { title: "Portal de Clientes", id: "bot" },
    ...
    const portalLabel = currentLang === "es" ? "PORTAL DE CLIENTES" : "CUSTOMER PORTAL";
    const whatsappUrl = "https://wa.me/50589106157?text=Hola,%20me%20gustar%C3%ADa%20obtener%20m%C3%A1s%20informaci%C3%B3n%20sobre%20los%20servicios%20de%20Robotic%20Nicaragua.";
    return /* @__PURE__ */ import_react3.default.createElement("header", { id: "app-header", className: "relative w-full bg-white shadow-sm transition-all duration-300" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-white text-xs sm:text-sm font-bold text-center py-2.5 px-4 select-none tracking-wide", style: { backgroundColor: "#3b82f6" } }, announcementText), /* @__PURE__ */ import_react3.default.createElement("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-2 md:py-3" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "hidden md:grid grid-cols-12 items-center gap-4" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "col-span-4 flex items-center gap-4" }, /* @__PURE__ */ import_react3.default.createElement(
      ...
      "button",
      {
        ...
        className: "flex items-center justify-center gap-2 w-full border-2 border-[#0A3E62] text-[#0A3E62] py-2.5 rounded font-bold text-xs uppercase hover:bg-[#0A3E62] hover:text-white transition duration-200 mt-2 shadow-sm cursor-pointer"
      },
      portalLabel
    ))));
  }
  ...
  function InicioView({ onPageChange, onOpenModal }) {
    ...
    const pricingPlans = [
      ...
      },
      {
        ...
        price: "$49.99",
        period: "/ mes",
        desc: "Ideal para peque\xF1os negocios en Managua que buscan liberar tiempo.",
        features: [
          "Configuraci\xF3n completa por nosotros",
          "Hasta 1 bots especializados",
          "IA con respuesta inteligente",
          "Soporte t\xE9cnico v\xEDa WhatsApp"
        ],
        popular: true,
      ...
      },
      {
        ...
        price: "$119.99",
        period: "/ mes",
        desc: "Automatizaci\xF3n total avanzada para empresas en crecimiento.",
        features: [
          "Consultor\xEDa y dise\xF1o de flujos",
          "Hasta 2 bots trabajando 24/7",
          "Reconocimiento de voz e im\xE1genes",
          "Integraci\xF3n con tus sistemas"
        ],
        primary: true,
    ...
    return /* @__PURE__ */ import_react5.default.createElement("div", { id: "inicio-view", className: "w-full" }, /* @__PURE__ */ import_react5.default.createElement("section", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 md:pt-16 pb-12 text-left flex flex-col items-start" }, /* @__PURE__ */ import_react5.default.createElement("span", { className: "text-[10px] font-extrabold tracking-widest text-blue-600 uppercase bg-blue-50 px-3 py-1 rounded-full mb-4 select-none" }, "AUTOMATIZACI\xD3N CON IA & WEB"), /* @__PURE__ */ import_react5.default.createElement("h1", { className: "font-extrabold leading-tight text-slate-800 text-3xl sm:text-4xl md:text-5xl tracking-tight mb-6 max-w-2xl" }, "Tu negocio atendido las 24 horas,", " ", /* @__PURE__ */ import_react5.default.createElement(
      ...
      /* @__PURE__ */ import_react5.default.createElement("div", null, /* @__PURE__ */ import_react5.default.createElement("h3", { className: "text-lg font-extrabold text-slate-800" }, plan.name), /* @__PURE__ */ import_react5.default.createElement("div", { className: "mt-4 flex items-baseline gap-1" }, /* @__PURE__ */ import_react5.default.createElement("span", { className: "text-3xl sm:text-4xl font-black text-slate-800" }, plan.price), /* @__PURE__ */ import_react5.default.createElement("span", { className: "text-xs text-slate-400 font-semibold" }, plan.period)), /* @__PURE__ */ import_react5.default.createElement("p", { className: "text-slate-500 text-xs leading-relaxed mt-3 mb-6 min-h-[36px]" }, plan.desc), /* @__PURE__ */ import_react5.default.createElement("ul", { className: "space-y-3 border-t border-slate-50 pt-6" }, plan.features.map((feat, fIdx) => /* @__PURE__ */ import_react5.default.createElement("li", { key: fIdx, className: "flex items-center gap-2.5 text-xs text-slate-600" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "w-4 h-4 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center shrink-0 shadow-sm border border-blue-400/20" }, /* @__PURE__ */ import_react5.default.createElement(Check, { className: "w-2.5 h-2.5 text-white stroke-[4]" })), /* @__PURE__ */ import_react5.default.createElement("span", null, feat))))),
      ...
      /* @__PURE__ */ import_react5.default.createElement("div", null, /* @__PURE__ */ import_react5.default.createElement("h3", { className: "text-lg font-extrabold text-slate-800" }, service.name), /* @__PURE__ */ import_react5.default.createElement("div", { className: "mt-3" }, /* @__PURE__ */ import_react5.default.createElement("span", { className: "bg-slate-50 text-slate-600 border border-slate-200/50 text-[10px] font-extrabold tracking-wider uppercase px-2.5 py-1 rounded-full" }, service.tag)), /* @__PURE__ */ import_react5.default.createElement("p", { className: "text-slate-500 text-xs leading-relaxed mt-4 mb-6 min-h-[36px]" }, service.desc), service.video && /* @__PURE__ */ import_react5.default.createElement("div", { className: "w-full rounded-xl overflow-hidden mb-6 bg-slate-100/50 border border-slate-100 relative group cursor-pointer shadow-sm hover:shadow-md transition-shadow", style: { aspectRatio: '16/9' }, onClick: () => setActiveVideo("https://player.vimeo.com/video/1219436943?autoplay=1&muted=0&color=0A3E62") }, /* @__PURE__ */ import_react5.default.createElement("iframe", { src: service.video, className: "w-full h-full pointer-events-none scale-[1.02]", frameBorder: "0", allow: "autoplay; fullscreen; picture-in-picture", allowFullScreen: true }), /* @__PURE__ */ import_react5.default.createElement("div", { className: "absolute inset-0 bg-transparent group-hover:bg-black/10 transition-colors z-10" })), service.img && /* @__PURE__ */ import_react5.default.createElement("div", { className: "w-full rounded-xl overflow-hidden mb-6 bg-slate-100/50 border border-slate-100 relative shadow-sm cursor-pointer group", style: { aspectRatio: '16/9' }, onClick: () => setActiveImage(service.img) }, /* @__PURE__ */ import_react5.default.createElement("img", { src: service.img, alt: service.name, className: "w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" }), /* @__PURE__ */ import_react5.default.createElement("div", { className: "absolute inset-0 bg-transparent group-hover:bg-black/10 transition-colors z-10" })), service.features && service.features.length > 0 && /* @__PURE__ */ import_react5.default.createElement("ul", { className: "space-y-3 border-t border-slate-50 pt-6" }, service.features.map((feat, fIdx) => /* @__PURE__ */ import_react5.default.createElement("li", { key: fIdx, className: "flex items-center gap-2.5 text-xs text-slate-600" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "w-4 h-4 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center shrink-0 shadow-sm border border-blue-400/20" }, /* @__PURE__ */ import_react5.default.createElement(Check, { className: "w-2.5 h-2.5 text-white stroke-[4]" })), /* @__PURE__ */ import_react5.default.createElement("span", null, feat))))),
      /* @__PURE__ */ import_react5.default.createElement("div", { className: "flex justify-center w-full mt-6" }, /* @__PURE__ */ import_react5.default.createElement(
        "a",
        {
          href: service.btnUrl,
    ...
    ))))), /* @__PURE__ */ import_react5.default.createElement("section", { className: "py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "text-center max-w-3xl mx-auto mb-16" }, /* @__PURE__ */ import_react5.default.createElement("span", { className: "text-[10px] font-extrabold tracking-widest text-blue-600 uppercase bg-blue-50 px-3 py-1 rounded-full" }, "Nuestras Ventajas"), /* @__PURE__ */ import_react5.default.createElement("h2", { className: "text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight mt-4" }, "Impulsa tu negocio con Robotic"), /* @__PURE__ */ import_react5.default.createElement("p", { className: "text-slate-500 text-sm sm:text-base mt-2" }, "Automatizaci\xF3n inteligente dise\xF1ada para maximizar la eficiencia y el crecimiento de tu empresa, tanto en Nicaragua como a nivel global.")), /* @__PURE__ */ import_react5.default.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6 justify-center items-stretch" }, features.map((feat, index) => {
      if (feat.img) {
  ...
  function BotView() {
    ...
    const chatEndRef = (0, import_react10.useRef)(null);
    ...
    (0, import_react10.useEffect)(() => {
      setMessages([
        {
          text: "\xA1Hola! Bienvenido a **Robotic System** v13.2. \u{1F680} Soy Samael, tu consultor virtual con Inteligencia Artificial.\n\n\xBFEn qu\xE9 \xE1rea te gustar\xEDa que trabajemos hoy?\n\n- **Automatizar ventas/mensajes** (Chatbots inteligentes para WhatsApp, IG, FB)\n- **Crear o mejorar tu sitio web** (Landing pages o tiendas en l\xEDnea)\n- **Soporte t\xE9cnico o mantenimiento** (macOS, Windows y redes empresariales)\n\nEscr\xEDbeme cualquier consulta y con gusto te asesorar\xE9 en tiempo real. \xA1Estoy listo!",
          sender: "bot",
          time: getCurrentTime()
        }
      ]);
    ...
    const handleSend = async () => {
      ...
      try {
        ...
        if (data.text) {
          ...
          throw new Error("No se recibi\xF3 respuesta de texto");
        }
      } catch (error) {
        ...
        setTimeout(() => {
          ...
          let fallbackReply = "";
          if (cleanText.includes("AUTOMATIZAR") || cleanText.includes("BOT") || cleanText.includes("VENTAS") || cleanText.includes("A")) {
            fallbackReply = "\xA1Excelente elecci\xF3n! La automatizaci\xF3n de ventas con chatbots integrados a WhatsApp y Redes Sociales te permite atender prospectos 24/7 y cerrar ventas sin intervenci\xF3n manual. Escr\xEDbenos por WhatsApp al **89106157** para dise\xF1ar tu flujo de ventas hoy mismo. \u{1F680}";
          } else if (cleanText.includes("WEB") || cleanText.includes("SITIO") || cleanText.includes("LANDING") || cleanText.includes("B")) {
            fallbackReply = "Un sitio web optimizado es la carta de presentaci\xF3n digital de tu negocio. Ofrecemos dise\xF1o premium responsive, velocidad de carga \xF3ptima y posicionamiento en Google. Escr\xEDbenos a **gerencia@roboticnic.com** para cotizar tu plataforma digital. \u{1F4BB}";
          } else if (cleanText.includes("SOPORTE") || cleanText.includes("MANTENIMIENTO") || cleanText.includes("RED") || cleanText.includes("C")) {
            fallbackReply = "Ofrecemos soporte t\xE9cnico corporativo completo: optimizaci\xF3n de sistemas operativos Windows y macOS, reparaci\xF3n f\xEDsica de hardware y configuraci\xF3n de seguridad en redes. Cont\xE1ctanos al **89106157** para agendar una visita t\xE9cnica presencial o remota. \u{1F6E0}\uFE0F";
          } else {
            fallbackReply = `\xA1Gracias por tu mensaje! En **Robotic System Nicaragua** estamos listos para ayudarte. Puedes contactarnos de inmediato llam\xE1ndonos o escribi\xE9ndonos por WhatsApp al **89106157**, o enviando un correo a **gerencia@roboticnic.com**. \xA1Te responderemos de inmediato!`;
          }
          setMessages((prev) => [
            ...prev,
            {
    ...
    const handleRestart = () => {
      ...
      setMessages([
        {
          text: "\xA1Hola de nuevo! He reiniciado nuestra sesi\xF3n. \u{1F504}\n\n\xBFEn qu\xE9 \xE1rea te gustar\xEDa que trabajemos hoy?\n\n- **Automatizar ventas/mensajes**\n- **Crear o mejorar tu sitio web**\n- **Soporte t\xE9cnico o mantenimiento**\n\nEscr\xEDbeme con total libertad para iniciar tu consultor\xEDa.",
          sender: "bot",
          time: getCurrentTime()
        }
      ]);
    ...
    const renderMessageText = (text, sender) => {
      return text.split("\n").map((line, i) => {
        ...
        const renderedParts = parts.map((part, j) => {
          if (part.startsWith("**") && part.endsWith("**")) {
            return /* @__PURE__ */ import_react10.default.createElement(
              ...
              {
                key: j,
                className: sender === "bot" ? "font-bold text-blue-300" : "font-extrabold text-white"
              },
              part.slice(2, -2)
            );
          }
        ...
        return /* @__PURE__ */ import_react10.default.createElement("div", { key: i, className: isBullet ? "pl-3 flex items-start gap-1.5 my-1" : "min-h-[1.2em]" }, isBullet && /* @__PURE__ */ import_react10.default.createElement("span", { className: "text-blue-400 select-none font-bold" }, "\u2022"), /* @__PURE__ */ import_react10.default.createElement("span", null, renderedParts));
      });
    };
    return /* @__PURE__ */ import_react10.default.createElement("div", { id: "bot-view", className: "w-full bg-slate-50/50 py-6 sm:py-8" }, /* @__PURE__ */ import_react10.default.createElement("div", { className: "max-w-5xl mx-auto px-4 sm:px-6" }, /* @__PURE__ */ import_react10.default.createElement("div", { className: "text-center max-w-2xl mx-auto mb-6" }, /* @__PURE__ */ import_react10.default.createElement("span", { className: "inline-flex items-center gap-1 text-[10px] font-bold tracking-wider text-blue-600 uppercase bg-blue-50 px-2 py-1 rounded-full" }, /* @__PURE__ */ import_react10.default.createElement(Sparkles, { className: "w-3 h-3" }), "Asistente de IA en vivo"), /* @__PURE__ */ import_react10.default.createElement("h1", { className: "text-xl sm:text-2xl font-black text-slate-800 tracking-tight mt-2.5 mb-2 leading-tight" }, "Chatea con Samael Bot"), /* @__PURE__ */ import_react10.default.createElement("p", { className: "text-slate-500 text-xs sm:text-sm leading-relaxed" }, "Experimenta el poder de nuestros asistentes con inteligencia artificial integrados. Prueba flujos de trabajo, realiza consultas t\xE9cnicas u obt\xE9n cotizaciones autom\xE1ticas conversando abajo.")), /* @__PURE__ */ import_react10.default.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-8 items-start" }, /* @__PURE__ */ import_react10.default.createElement("div", { className: "lg:col-span-5 space-y-4" }, /* @__PURE__ */ import_react10.default.createElement("div", { className: "bg-white border border-slate-100 rounded-xl p-4 shadow-sm" }, /* @__PURE__ */ import_react10.default.createElement("h2", { className: "text-sm font-bold text-slate-800 mb-3 flex items-center gap-2" }, /* @__PURE__ */ import_react10.default.createElement("span", { className: "p-1 bg-blue-50 text-blue-600 rounded-lg" }, /* @__PURE__ */ import_react10.default.createElement(Bot, { className: "w-3.5 h-3.5" })), "\xBFQu\xE9 puede hacer por ti?"), /* @__PURE__ */ import_react10.default.createElement("ul", { className: "space-y-2" }, /* @__PURE__ */ import_react10.default.createElement("li", { className: "flex items-start gap-2.5" }, /* @__PURE__ */ import_react10.default.createElement(CircleCheckBig, { className: "w-3.5 h-3.5 text-green-500 mt-0.5 shrink-0" }), /* @__PURE__ */ import_react10.default.createElement("p", { className: "text-[11px] text-slate-600 leading-normal" }, /* @__PURE__ */ import_react10.default.createElement("strong", null, "Respuestas Inteligentes"), ": Analiza requerimientos usando Gemini IA.")), /* @__PURE__ */ import_react10.default.createElement("li", { className: "flex items-start gap-2.5" }, /* @__PURE__ */ import_react10.default.createElement(CircleCheckBig, { className: "w-3.5 h-3.5 text-green-500 mt-0.5 shrink-0" }), /* @__PURE__ */ import_react10.default.createElement("p", { className: "text-[11px] text-slate-600 leading-normal" }, /* @__PURE__ */ import_react10.default.createElement("strong", null, "Captura de Clientes"), ": Recolecta informaci\xF3n y agenda asesor\xEDas.")), /* @__PURE__ */ import_react10.default.createElement("li", { className: "flex items-start gap-2.5" }, /* @__PURE__ */ import_react10.default.createElement(CircleCheckBig, { className: "w-3.5 h-3.5 text-green-500 mt-0.5 shrink-0" }), /* @__PURE__ */ import_react10.default.createElement("p", { className: "text-[11px] text-slate-600 leading-normal" }, /* @__PURE__ */ import_react10.default.createElement("strong", null, "Integraci\xF3n Omnicanal"), ": Funciona en WhatsApp, Messenger o Web.")))), /* @__PURE__ */ import_react10.default.createElement("div", { className: "bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-xl p-4 shadow-sm border border-slate-800" }, /* @__PURE__ */ import_react10.default.createElement("h3", { className: "text-xs font-bold tracking-wide uppercase text-blue-400 mb-1.5" }, "Asesor\xEDa Inmediata"), /* @__PURE__ */ import_react10.default.createElement("p", { className: "text-[11px] text-slate-300 leading-relaxed mb-4" }, "\xBFPrefieres hablar directamente con nuestro equipo t\xE9cnico o cotizar un bot a medida?"), /* @__PURE__ */ import_react10.default.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ import_react10.default.createElement(
      "a",
      {
        href: "https://wa.me/50589106157?text=Hola,%20me%20gustar%C3%ADa%20contratar%20sus%20servicios%20de%20chatbots",
        target: "_blank",
        rel: "noreferrer",
        className: "w-full flex items-center justify-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded-lg text-[11px] transition duration-200 shadow shadow-blue-600/10 cursor-pointer"
      },
      /* @__PURE__ */ import_react10.default.createElement(MessageSquare, { className: "w-3.5 h-3.5" }),
      "Contratar mi Bot por WhatsApp"
    ), /* @__PURE__ */ import_react10.default.createElement(
      "button",
      {
        onClick: handleRestart,
        className: "w-full flex items-center justify-center gap-1.5 border border-slate-700 bg-slate-800/40 hover:bg-slate-800 text-slate-200 font-semibold py-2 px-3 rounded-lg text-[11px] transition duration-200 cursor-pointer"
      },
      /* @__PURE__ */ import_react10.default.createElement(RefreshCw, { className: "w-3 h-3" }),
      "Reiniciar Conversaci\xF3n"
    ))), /* @__PURE__ */ import_react10.default.createElement("div", { className: "bg-blue-50/50 border border-blue-100 rounded-xl p-3 flex gap-2.5 items-start" }, /* @__PURE__ */ import_react10.default.createElement(CircleQuestionMark, { className: "w-4 h-4 text-blue-500 shrink-0 mt-0.5" }), /* @__PURE__ */ import_react10.default.createElement("div", null, /* @__PURE__ */ import_react10.default.createElement("h4", { className: "text-[11px] font-bold text-blue-900" }, "\xBFC\xF3mo interactuar?"), /* @__PURE__ */ import_react10.default.createElement("p", { className: "text-[10px] text-blue-700 leading-relaxed mt-0.5" }, "Escribe libremente consultas de chatbots, p\xE1ginas web o soporte t\xE9cnico. Samael te responder\xE1 de inmediato.")))), /* @__PURE__ */ import_react10.default.createElement("div", { className: "lg:col-span-7 flex justify-center" }, /* @__PURE__ */ import_react10.default.createElement(
      "div",
      {
        className: "w-full max-w-[290px] bg-slate-950 rounded-[36px] p-2 shadow-2xl relative border-4 border-slate-900/90 overflow-hidden",
        style: { boxShadow: "0 25px 50px -12px rgba(15, 23, 42, 0.4)" }
      },
      /* @__PURE__ */ import_react10.default.createElement("div", { className: "absolute top-3.5 left-1/2 -translate-x-1/2 w-24 h-4 bg-slate-950 rounded-full z-30 flex items-center justify-center" }, /* @__PURE__ */ import_react10.default.createElement("div", { className: "w-2.5 h-2.5 rounded-full bg-slate-900 border border-slate-800/30 absolute right-3" })),
      /* @__PURE__ */ import_react10.default.createElement("div", { className: "w-full h-[410px] bg-[#121b22] rounded-[28px] overflow-hidden flex flex-col justify-between relative z-10 border border-slate-800/30" }, /* @__PURE__ */ import_react10.default.createElement("div", { className: "bg-[#1f2c34] pt-5 pb-2 px-3 flex items-center justify-between border-b border-slate-900/50 shrink-0" }, /* @__PURE__ */ import_react10.default.createElement("div", { className: "flex items-center gap-2.5" }, /* @__PURE__ */ import_react10.default.createElement("div", { className: "w-7 h-7 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-500 flex items-center justify-center text-white shadow shadow-blue-500/10 shrink-0" }, /* @__PURE__ */ import_react10.default.createElement(Bot, { className: "w-3.5 h-3.5" })), /* @__PURE__ */ import_react10.default.createElement("div", null, /* @__PURE__ */ import_react10.default.createElement("h3", { className: "font-bold text-slate-100 text-[10px] tracking-wide leading-tight" }, "Samael Bot"), /* @__PURE__ */ import_react10.default.createElement("span", { className: "text-[8px] text-green-400 font-bold flex items-center gap-1" }, /* @__PURE__ */ import_react10.default.createElement("span", { className: "w-1.2 h-1.2 rounded-full bg-green-400 animate-pulse" }), "En l\xEDnea (IA Activa)")))), /* @__PURE__ */ import_react10.default.createElement(
        "div",
        {
        ...
        messages.map((msg, index) => /* @__PURE__ */ import_react10.default.createElement(
          "div",
          {
            key: index,
            className: `max-w-[85%] rounded-2xl p-3 text-[11px] leading-relaxed shadow-sm flex flex-col relative animate-in fade-in duration-150 ${msg.sender === "bot" ? "bg-[#202c33] text-slate-200 rounded-tl-none self-start border border-slate-800/40" : "bg-[#005c4b] text-white rounded-tr-none self-end border border-emerald-800/30"}`
          },
          /* @__PURE__ */ import_react10.default.createElement("div", { className: "whitespace-pre-wrap" }, renderMessageText(msg.text, msg.sender)),
          /* @__PURE__ */ import_react10.default.createElement("span", { className: `text-[8px] mt-1.5 self-end ${msg.sender === "bot" ? "text-slate-400" : "text-emerald-200"}` }, msg.time)
        )),
        isTyping && /* @__PURE__ */ import_react10.default.createElement("div", { className: "bg-[#202c33] text-slate-200 rounded-2xl rounded-tl-none p-3 text-[11px] max-w-[70px] self-start shadow-sm border border-slate-800/40 flex gap-1 items-center justify-center" }, /* @__PURE__ */ import_react10.default.createElement("span", { className: "w-1.5 h-1.5 rounded-full bg-blue-400 animate-bounce [animation-delay:-0.3s]" }), /* @__PURE__ */ import_react10.default.createElement("span", { className: "w-1.5 h-1.5 rounded-full bg-blue-400 animate-bounce [animation-delay:-0.15s]" }), /* @__PURE__ */ import_react10.default.createElement("span", { className: "w-1.5 h-1.5 rounded-full bg-blue-400 animate-bounce" })),
        /* @__PURE__ */ import_react10.default.createElement("div", { ref: chatEndRef })
      ), /* @__PURE__ */ import_react10.default.createElement("div", { className: "p-3 bg-[#1f2c34] flex items-center gap-2 border-t border-slate-900/50 shrink-0" }, /* @__PURE__ */ import_react10.default.createElement(
        "input",
        {
          type: "text",
          value: userInput,
          ...
          className: "flex-grow bg-[#2a3942] text-white border-none rounded-full px-4 py-2 text-[11px] outline-none placeholder-slate-400 focus:ring-1 focus:ring-blue-500/30"
        }
      ), /* @__PURE__ */ import_react10.default.createElement(
        "button",
        {
          ...
          className: "w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center shadow hover:bg-blue-700 transition cursor-pointer shrink-0 disabled:opacity-40 disabled:cursor-not-allowed"
        },
        /* @__PURE__ */ import_react10.default.createElement(Send, { className: "w-3.5 h-3.5 ml-0.5" })
      )))
    )))));
  }
  ...
  function App() {
    ...
    const renderActiveView = () => {
      switch (currentPage) {
        ...
        case "bot":
          return /* @__PURE__ */ import_react13.default.createElement(BotView, null);
        default:
          return /* @__PURE__ */ import_react13.default.createElement(
            InicioView,
            {
