var MyApp = (() => {
  ...
  function Header({ currentPage, onPageChange, onOpenModal }) {
    ...
    return /* @__PURE__ */ import_react3.default.createElement("header", { id: "app-header", className: "relative w-full bg-white shadow-sm transition-all duration-300" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "bg-[#0A3E62] text-white text-xs sm:text-sm font-bold text-center py-2.5 px-4 select-none tracking-wide" }, announcementText), /* @__PURE__ */ import_react3.default.createElement("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-2 md:py-3" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "hidden md:grid grid-cols-12 items-center gap-4" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "col-span-4 flex items-center gap-4" }, /* @__PURE__ */ import_react3.default.createElement(
      "img",
      {
        src: robotic_default,
        alt: "Robotic Logo",
  ...
  function InicioView({ onPageChange, onOpenModal }) {
    ...
    ), " ", "sin interrupciones."), /* @__PURE__ */ import_react5.default.createElement("div", { className: "flex flex-row flex-wrap gap-2 w-auto mb-12 select-none justify-start items-center" }, /* @__PURE__ */ import_react5.default.createElement(
      "button",
      {
        onClick: () => onPageChange("bot"),
        className: "bg-[#0A3E62] hover:bg-[#124C73] text-white font-bold tracking-wider uppercase px-3 py-1 rounded-sm shadow-2xs cursor-pointer flex items-center gap-1 text-[10.5px] border border-[#0A3E62]/10 transition-colors duration-300 ease-in-out"
      },
      "CONTACTAR",
      /* @__PURE__ */ import_react5.default.createElement(ArrowRight, { className: "w-3 h-3 text-white/95" })
    ), /* @__PURE__ */ import_react5.default.createElement(
      "button",
      {
        onClick: onOpenModal,
        className: "bg-white border border-slate-200/50 text-[#0A3E62] hover:bg-slate-50/80 font-bold tracking-wider uppercase px-3 py-1 rounded-sm shadow-3xs cursor-pointer text-[10.5px] transition-colors duration-300 ease-in-out"
      },
      "TEAMS"
